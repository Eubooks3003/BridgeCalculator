...
class Truss():
    ...
    def draw_internal_forces(self):
        ...
        for i in range(len(self.truss_list)):
            ...
            for neighbour in self.truss_list[i].internal_forces:
                if neighbour.loc[0] - self.truss_list[i].loc[0] < 0:
                    f_x_net += self.truss_list[i].internal_forces[neighbour].get_x_mag()

            node_forces_list.append(abs(f_x_net))
...
truss_modified_cs_members = {(5,7): {"width": 75, "thickness": 2.54}, (17,18):{"width": 75, "thickness": 2.54}, (7,9):{"width": 75, "thickness": 2.54}, (9,10):{"width": 75, "thickness": 2.54}, (12,14):{"width": 75, "thickness": 2.54}, (14,16):{"width": 75, "thickness": 2.54}, (16,18):{"width": 75, "thickness": 2.54}, (16,17):{"width": 75, "thickness": 2.54}}
truss_modified_tab_length_nodes = {4: 15, 5: 20, 6:20, 7: 25, 8: 20, 11: 15, 12: 20, 13: 20, 14: 20, 15: 20, 16: 20, 17: 20 }

beam_segments =    [((0,1290),     {"top_thickness": 1.27,
                                    "top_width": 100,
                                    "web_thickness": 1.27,
                                    "web_height": 105-1.27*2,
...
#simulate_train_load(bridge, 1073)
